...
An example of such failure is given in subsection \ref{subsection:Change Pointer fault model} of section \ref{Section:Rust ported}.
Subsection \ref{subsection:Change Pointer fault model} is only a summary of the full version discussed in the FDTC paper (under submission) \cite{fdct2026}. 
