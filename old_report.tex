...
%---------------------------Introduction---------------------------
\section{Abstract}
\input{old_introduction/Abstract.tex}
\section{Introduction}
\input{old_introduction/introduction}

\section{Related work}
\input{old_introduction/Related_work}



%--------------------------Core------------------------------------
\section{Contribution}
\input{old_core/contribution.tex}

\section{result}
\input{old_core/result.tex}
\section{Conclusion}
\input{old_core/conclusion_limit}
\onecolumn
\section{Reference}
