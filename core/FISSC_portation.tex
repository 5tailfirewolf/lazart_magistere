...
\label{FISSC}
We contributed to Lazart in order to implement the Rust language in the system and find a way to evaluate and compare the results produced by Lazart.

We evaluated two different pieces of code to see the differences in attacks detected by Lazart.
The first code evaluated is \texttt{memcmps}, a secure version of \texttt{memcmp}.
The second code is \texttt{verify\_pin}, a program used to validate a PIN code on a PIN pad.
We used control-flow graphs to understand the difference between C and Rust compiled code and to understand what happened during the compilation and mutation of the code.
%--------------------------------------------------------------verifypin--------------------------------------------------------------------------------
