...
\todo[inline]{discovery introduction + n'hésite pas à reprendre des bouts de texte rédigés dans le papier FDTC si besoin}
...
We generated a control flow graph from the generated LLVM code, which is stored in ".ll" file.

With Lazart, it is also possible to generate a control flow graph from the mutated code produced from Wolverine.
...
See the example in the appendix A in Figure \ref{fig:annexe1}.
%--------------------------------------------------------------memcmps--------------------------------------------------------------------------------
\subsection{memcmps}
