...
The control flow graph was primarily used to understand the optimization of \texttt{rustc} with their own boolean and give an additional explanation of one of the findings with Table \ref{tbl:results-fissc-vp}: \texttt{verify\_pin} (see below in section \ref{Section:FISSC}) in the section \ref{Section:result section}.